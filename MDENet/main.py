...
from networks.our5_c_v2 import MDENet

TITLE = 'our5_c_v2_DSIFNCD'
...
def main(args):
    net = MDENet(in_ch=3, out_ch=1).to(device)
    ...
    scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer,total_epochs,eta_min=0)

    dataset_train = RsDataset(train_src_t1, train_src_t2, train_label,
                              t1_transform=src_transform,
                              t2_transform=src_transform,
                              label_transform=label_transform)
    dataset_val = RsDataset(val_src_t1, val_src_t2, val_label,
                            t1_transform=src_transform,
                            t2_transform=src_transform,
                            label_transform=label_transform)
