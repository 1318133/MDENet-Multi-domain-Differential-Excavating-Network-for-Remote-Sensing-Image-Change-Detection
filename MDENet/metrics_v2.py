...
def get_score(confusionMatrix):
    ...
    return precision, recall, f1score, iou, kc, po


def get_score_sum(confusionMatrix):
    num_classes = confusionMatrix.shape[0]
    precision, recall, f1score, iou, kc, oa = get_score(confusionMatrix)
    ...
    return cls_precision, cls_recall, cls_f1, cls_iou, kc, oa
